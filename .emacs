...
;;(add-to-list 'load-path' "/home/huilinye/.emacs.d/s")
(require 's)

;;(add-to-list 'load-path' "/home/huilinye/.emacs.d/origami")
(require 'origami)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "monospace":weight normal :height 181 :width normal)))))
